  ...
  <div class="cdrcontainer">
    ...
    <div class="calllist">
      <el-table :data="datalist" border style="width: 100%">
        ...
        <el-table-column prop="maxcalltime" label="最后通话时间"></el-table-column>
        <!--<el-table-column prop="timelenght" sortable label="第几次通话" width="130"></el-table-column>-->
        ...
        <!--<el-table-column prop="basestationnumber" sortable label="基站小区" width="120"></el-table-column>-->
        <!--<el-table-column prop="logicalcellnumber" sortable label="逻辑小区" width="120"></el-table-column>-->
        <!--<el-table-column prop="stationnumber" sortable label="基站地址" width="120"></el-table-column>-->
      </el-table>
...
<script>
  ...
  import {getLostNumberAnalysisList} from '@/service/cdr'
  export default {
    name: 'oneAnalysis',
    components: {
      callNumDetail
    ...
    methods: {
      ...
      queryList () {
        ...
        getLostNumberAnalysisList(params).then((res) => {
